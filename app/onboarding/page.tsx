...
const CHALLENGE_TYPES: { value: ChallengeType; label: string; description: string }[] = [
  { value: "behavioral", label: "Behavioral", description: "Build a consistent habit or routine" },
  { value: "habit", label: "Daily Habit", description: "Something you'll do every day" },
  { value: "wellness", label: "Wellness", description: "Improve your physical or mental health" },
  { value: "fitness", label: "Fitness", description: "Exercise and physical activity" },
  { value: "learning", label: "Learning", description: "Develop new skills or knowledge" },
  { value: "productivity", label: "Productivity", description: "Work habits and focus" },
  { value: "consistency", label: "Consistency", description: "Show up regularly for something" },
...
const DURATION_OPTIONS = [
  ...
  { days: 21, label: "3 weeks", description: "The classic habit-forming period" },
...
export default function OnboardingPage() {
    ...
    const initSession = async () => {
      ...
      try {
        ...
        if (data.session.challenge_draft) {
          setChallengeDraft(prev => ({ ...prev, ...data.session.challenge_draft }));
        }
  ...
  const updateSession = useCallback(
    async (updates: Partial<{ currentStep: OnboardingStep; stepsCompleted: OnboardingStep[]; challengeDraft: ChallengeDraft }>) => {
      const token = getToken();
  ...
  const goToStep = useCallback(
    (step: OnboardingStep) => {
      ...
      if (targetIndex <= currentIndex || stepsCompleted.includes(STEPS[targetIndex - 1]?.key)) {
        setCurrentStep(step);
  ...
  const handleSelectChallenge = async (challenge: SuggestedChallenge) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "Failed to select challenge");
    }
  };
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Image
                ...
                height={32}
              />
              <span className="text-lg font-serif font-bold">Your Challenge Journey</span>
            </div>
                ...
                {i < STEPS.length - 1 && (
                  <div
                    className={cn(
                      ...
                      stepsCompleted.includes(key) ? "bg-green-500" : "bg-muted"
                    )}
                  />
                )}
              </div>
              ...
              <div className="neumorphic rounded-2xl p-6 mb-6">
                ...
                <div className="h-64 overflow-y-auto text-sm text-muted-foreground space-y-4 pr-4">
                  ...
                  <p>
                    ...
                    Showup is a platform designed to help you build better habits through financial 
                    accountability and social support.
                  </p>

                  <h3 className="font-semibold text-foreground">2. How Showup Works</h3>
                  <p>
                    When you create a challenge, you deposit funds that are held securely until 
                    your challenge is complete. Your designated guarantors will verify your progress. 
                    If you successfully complete your challenge, your deposit is returned. If you 
                    fail, your guarantors can vote on a &quot;Path of Redemption&quot; to help you recover.
                  </p>

                  <h3 className="font-semibold text-foreground">3. Deposits and Payments</h3>
                  <p>
                    All deposits are processed securely through Stripe. Funds are held in escrow 
                    until your challenge concludes. We do not have access to your payment information.
                  </p>

                  <h3 className="font-semibold text-foreground">4. Guarantors</h3>
                  <p>
                    Guarantors are friends you designate to verify your challenge completion. They 
                    must be real people with valid email addresses. They will receive notifications 
                    about your progress and may be asked to vote on outcomes.
                  </p>

                  <h3 className="font-semibold text-foreground">5. Privacy</h3>
                  <p>
                    We respect your privacy. Your challenge details are only shared with your 
                    designated guarantors. We use anonymized data to improve our service. See our 
                    full Privacy Policy for details.
                  </p>

                  <h3 className="font-semibold text-foreground">6. Refunds</h3>
                  <p>
                    Deposits for completed challenges are returned within 7 business days. For 
                    failed challenges, the outcome depends on guarantor voting. We do not offer 
                    refunds for challenges abandoned mid-progress.
                  </p>

                  <h3 className="font-semibold text-foreground">7. User Conduct</h3>
                  <p>
                    You agree to use Showup responsibly and not create challenges that are 
                    harmful, illegal, or impossible to verify. We reserve the right to suspend 
            ...
            <div className="animate-fade-in-up">
              <div className="text-center mb-6">
                ...
                <p className="text-muted-foreground">
                  Let&apos;s find the perfect challenge for you. Sometimes the best challenges 
                  are mundane things we want to do consistently.
                </p>
              </div>
                ...
                {aiMessages.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-full text-center">
                    ...
                    <p className="text-sm text-muted-foreground/70 mt-2">
                      Try: &quot;I want to be more consistent with my skincare routine&quot;
                    </p>
                  </div>
                ) : (
                        ...
                        >
                          ...
                          {msg.suggestedChallenge && (
                            <div className="mt-3 p-3 rounded-xl bg-background/50 border border-border">
                              <p className="font-semibold text-sm">{msg.suggestedChallenge.title}</p>
                              <p className="text-xs text-muted-foreground mt-1">
                                {msg.suggestedChallenge.suggestedDuration} days | ${msg.suggestedChallenge.suggestedDeposit}
                              </p>
                              <button
                                onClick={() => handleSelectChallenge(msg.suggestedChallenge!)}
                      ...
                      <div className="flex justify-start">
                        <div className="bg-muted rounded-2xl px-4 py-3">
                          <div className="flex gap-1">
                            ...
                            <span className="w-2 h-2 bg-muted-foreground/50 rounded-full animate-bounce" style={{ animationDelay: "0.6s" }} />
                          </div>
                        </div>
                      </div>
                    )}
              ...
              {suggestedChallenges.length > 0 && (
                <div className="mb-4">
                  <p className="text-sm font-medium mb-2">Suggested Challenges:</p>
                  <div className="space-y-2">
                    {suggestedChallenges.map((challenge, i) => (
                      ...
                      >
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          {challenge.suggestedDuration} days | ${challenge.suggestedDeposit} | {challenge.type}
                        </p>
                      </button>
                    ))}
                  </div>
          ...
          {currentStep === "challenge-definition" && (
            <div className="animate-fade-in-up">
              <div className="text-center mb-6">
                ...
                <p className="text-muted-foreground">
                  What exactly will you commit to? Be specific - behavioral challenges work best.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setChallengeDraft(prev => ({ ...prev, title: e.target.value }))}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) => setChallengeDraft(prev => ({ ...prev, description: e.target.value }))}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {CHALLENGE_TYPES.map(({ value, label }) => (
                      <button
                        key={value}
                        onClick={() => setChallengeDraft(prev => ({ ...prev, type: value }))}
                        className={cn(
                ...
                <div className="rounded-xl bg-accent p-4 text-sm">
                  ...
                  <p className="text-muted-foreground mt-1">
                    The best challenges are specific and measurable. Instead of &quot;exercise more,&quot; 
                    try &quot;complete a 20-minute workout every morning.&quot;
                  </p>
                </div>

                <button
                  onClick={() => completeStep("challenge-definition")}
                  disabled={!challengeDraft.title || !challengeDraft.description}
                ...
                >
                  Continue <ChevronRight className="inline-block ml-2 h-5 w-5" />
                </button>
              </div>
            </div>
          )}
          ...
          {currentStep === "resolution" && (
            <div className="animate-fade-in-up">
              <div className="text-center mb-6">
                ...
                <p className="text-muted-foreground">
                  Your guarantors need to know what counts as success. How will they verify you did it?
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) => setChallengeDraft(prev => ({ ...prev, resolutionMethod: e.target.value }))}
                ...
                <div className="rounded-xl bg-muted p-4">
                  <p className="font-medium text-sm mb-2">Verification Ideas:</p>
          ...
          {currentStep === "deposit" && (
            <div className="animate-fade-in-up">
              <div className="text-center mb-6">
                ...
                <p className="text-muted-foreground">
                  Your deposit makes this real. Choose an amount that feels meaningful - 
                  enough to motivate you, but not cause stress.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {DEPOSIT_OPTIONS.map(({ amount, label, description }) => (
                      <button
                        key={amount}
                        onClick={() => setChallengeDraft(prev => ({ ...prev, depositAmount: amount }))}
                        className={cn(
                  ...
                  <div className="mt-3">
                    <input
                      ...
                      min="1"
                      max="10000"
                      value={challengeDraft.depositAmount}
                      onChange={(e) => setChallengeDraft(prev => ({ ...prev, depositAmount: parseInt(e.target.value) || 0 }))}
                    ...
                    />
                    <p className="text-xs text-muted-foreground text-center mt-1">Or enter a custom amount</p>
                  </div>
                </div>
                ...
                <div className="rounded-xl bg-accent p-4 text-sm">
                  <p className="text-accent-foreground">
                    <strong>Remember:</strong> Your deposit is returned when you successfully complete 
                    your challenge. Think of it as a commitment to yourself, not a cost.
                  </p>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    disabled={!challengeDraft.depositAmount || challengeDraft.depositAmount < 1}
                    className="flex-1 py-3 rounded-xl bg-primary text-primary-foreground font-medium transition-all hover:scale-[1.02] disabled:opacity-50"
                  >
                    Continue
                    <ChevronRight className="inline-block ml-2 h-5 w-5" />
          ...
          {currentStep === "notifications" && (
            <div className="animate-fade-in-up">
              <div className="text-center mb-6">
                ...
                <p className="text-muted-foreground">
                  Notifications help you build consistency. This challenge will become 
                ...
                <div className="neumorphic rounded-xl p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Get notified when it&apos;s time to do your challenge</p>
                    </div>
                    <button
                      onClick={() => setChallengeDraft(prev => ({
                        ...prev,
                        notificationSettings: {
                    ...
                    <div className="neumorphic rounded-xl p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Instant reminders on your device</p>
                        </div>
                    <button
                      onClick={() => setChallengeDraft(prev => ({
                        ...prev,
                        notificationSettings: {
                          ...
                          ...prev.notificationSettings,
                          pushEnabled: !prev.notificationSettings?.pushEnabled,
                        },
                      }))}
                      className={cn(
                        "w-12 h-6 rounded-full transition-all relative",
                    ...
                    <div className="neumorphic rounded-xl p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Daily digest to your inbox</p>
                        </div>
                    <button
                      onClick={() => setChallengeDraft(prev => ({
                        ...prev,
                        notificationSettings: {
                          enabled: prev.notificationSettings?.enabled ?? true,
                          ...prev.notificationSettings,
                          emailEnabled: !prev.notificationSettings?.emailEnabled,
                        },
                      }))}
                      className={cn(
                        "w-12 h-6 rounded-full transition-all relative",
          ...
          {currentStep === "activity-rate" && (
            <div className="animate-fade-in-up">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {FREQUENCY_OPTIONS.map(({ value, label }) => (
                      <button
                        key={value}
                        onClick={() => setChallengeDraft(prev => ({ ...prev, frequency: value }))}
                        className={cn(
                    ...
                    <div className="flex gap-2">
                      {["S", "M", "T", "W", "T", "F", "S"].map((day, i) => (
                        <button
                          key={i}
                          onClick={() => {
                            const current = challengeDraft.frequencyDetails?.daysOfWeek || [];
                            const updated = current.includes(i)
                              ? current.filter(d => d !== i)
                              : [...current, i];
                            setChallengeDraft(prev => ({
                              ...prev,
                              frequencyDetails: { ...prev.frequencyDetails, daysOfWeek: updated },
                            }));
                          }}
                          className={cn(
                            "w-10 h-10 rounded-full font-medium transition-all",
                            challengeDraft.frequencyDetails?.daysOfWeek?.includes(i)
                              ? "bg-primary text-primary-foreground"
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {DURATION_OPTIONS.map(({ days, label, description }) => (
                      <button
                        key={days}
                        onClick={() => setChallengeDraft(prev => ({ ...prev, durationDays: days }))}
                        className={cn(
                          "p-4 rounded-xl border text-left transition-all",
                ...
                <div className="rounded-xl bg-accent p-4 text-sm">
                  <p className="text-accent-foreground">
                    <strong>Start small:</strong> A 7-day challenge you complete builds more momentum 
                    than a 30-day challenge you abandon. You can always level up after you succeed.
                  </p>
                </div>
          ...
          {currentStep === "sharing" && (
            <div className="animate-fade-in-up">
              <div className="text-center mb-6">
                ...
                <p className="text-muted-foreground">
                  These friends will hold you accountable. They&apos;ll verify your progress 
                  and can vote on your Path of Redemption if needed.
                </p>
              </div>
                ...
                <div className="neumorphic rounded-xl p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{challengeDraft.title}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Duration</span>
                      <span className="font-medium">{challengeDraft.durationDays} days</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Frequency</span>
                      <span className="font-medium capitalize">{challengeDraft.frequency}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Deposit</span>
                      <span className="font-medium">${challengeDraft.depositAmount}</span>
                    </div>
                  </div>
                </div>
